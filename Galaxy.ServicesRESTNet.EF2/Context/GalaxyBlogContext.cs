...
namespace Galaxy.ServicesRESTNet.EF2.Context
{
    public partial class GalaxyBlogContext : DbContext
    {
        public GalaxyBlogContext()
        {
        }

        public GalaxyBlogContext(DbContextOptions<GalaxyBlogContext> options)
            : base(options)
        {
        }
